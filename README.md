...
**If the character drifts, don't use it.**
...
validate each output and discard inconsistent results.
...
Current approaches focus on improving generation quality.
...
This is a **quality control layer for character consistency**.
